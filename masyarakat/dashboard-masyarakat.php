...
//ambil data laporan dgn feedback
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-900" style="margin-top: 40px;">Welcome, <?= $_SESSION['username'] ?> 👋🏻</h1>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-xl-4 col-md-7 mb-5">
                            <div class="card shadow h-100 py-2" style="border-left: 5px solid #52ADF8;">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-gray-800 text-uppercase mb-1">My Reports</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $semua_laporan ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fa-solid fa-flag fas fa-2x" style="color: #52ADF8;"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-md-7 mb-5">
                            <div class="card shadow h-100 py-2" style="border-left: 5px solid #F89151;">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-gray-800 text-uppercase mb-1">Reports Processed</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $jumlah_pengaduan_proses ?></div>
                                        </div>
                                        <div class="col-auto">
                                            <i class="fas fa-solid fa-check fa-2x" style="color: #F89151;"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-4 col-md-7 mb-5">
                            <div class="card shadow h-100 py-2" style="border-left: 5px solid #9EDE65;">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-gray-800 text-uppercase mb-1">Reports Solved</div>
                                            <div class="row no-gutters align-items-center">
                                                <div class="col-auto">
                                        ...
                                        <div class="col-auto">
                                            <i class="fas fa-clipboard-list fa-2x" style="color: #9EDE65;"></i>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-reguler text-grey">Reports in Process</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <?php
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                                    <h6 class="m-0 font-weight-reguler text-grey">Reports Solved</h6>
                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <?php
                                    foreach ($reports_with_feedback as $p):
                                    ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a class="btn" style="background-color: #F89151; color: #ffff;" href="../auth/logout.php">Logout</a>
                </div>
            </div>
        </div>
    </div>
