            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Add your Feedback </h1>
                    </div>
                        ...
                        <div class="col-xl-12 col-lg-7">
                            <div class="card shadow mb-4">
                                ...
                                <div
                                    ...
                                    <h6 class="m-0 font-weight-bold text-success">Form Adding Feedback with the id <?= $report_id ?></h6>

                                </div>
                                <!-- Card Body -->
                                <div class="card-body">
                                    <form action="feedback.php?report_id=<?= htmlspecialchars($report_id) ?>" method="POST">
                                        <div class="form-group">
                                            <label for="feedback">Feedback</label>
                                            <textarea class="form-control" id="feedback" name="feedback" rows="4" required></textarea>
                                        </div>
                                        <button type="submit" class="btn btn-primary">Submit Feedback</button>
                                        <a href="laporan-proses.php" class="btn btn-secondary">Cancel</a>
                                    </form>
